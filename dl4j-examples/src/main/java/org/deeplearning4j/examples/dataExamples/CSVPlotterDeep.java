 ...
 */
public class CSVPlotterDeep {

    public static void main( String[] args ) throws IOException, InterruptedException
    {
        //String filename = new ClassPathResource("/DataExamples/CSVPlotData.csv").getFile().getPath();
		//String filename = new File(System.getProperty("user.dir")+"/dl4j-examples/src/main/resources/"+filename).getFile().getPath();
		String filename = (new File(System.getProperty("user.dir")+"/dl4j-examples/src/main/resources/"+"DataExamples/CSVPlotDataDeep.csv")).getPath();
		...
		MultiLayerNetwork net = fitStraightline(ds, args);
	 ...
	 */
	public static MultiLayerNetwork fitStraightline(DataSet ds, String[] args){
		int seed = 12345;
		double learningRate = 0.00001;
		double momentum = 0.9;
		int nEpochs = 200; // pass all data back/forw
		int iterations = 1; // pass batch back/forw
		if(args.length == 4){
		...
		MultiLayerConfiguration conf = new  NeuralNetConfiguration.Builder()
                ...
                .list()
                .layer(0, new DenseLayer.Builder().nIn(numInputs).nOut(numInputs*10)
                        .activation("sigmoid")
                        .build())
				.layer(1, new DenseLayer.Builder().nIn(numInputs*10).nOut(numOutputs)
                        .activation("sigmoid")
                        .build())
		...
		net.init();
	    net.setListeners(new ScoreIterationListener(1 + nEpochs*iterations / 100));
