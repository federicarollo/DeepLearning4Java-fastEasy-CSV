 ...
 * @author Peter Großmann
   @author Jeffrey Tang - RBM conf code
   @author Jason Albalah - misc
 *
 */
public class DeepAutoEncoderXORExample {
	...
	public static void main(String[] args) {
		...
		ds.shuffle();
		System.out.println("Args: learningRateDouble iterations lineSearchMaxIterations listener");
		...
		MultiLayerConfiguration multiLayerConfiguration = new NeuralNetConfiguration.Builder()
                ...
                .maxNumLineSearchIterations(Integer.parseInt(args[2])) // Magical Optimisation Stuff - only for CONJUGATE_GRADIENT
                .regularization(true)
                .list()
...
*/
		...
		net.setListeners(new ScoreIterationListener(Integer.parseInt(args[3])));
		...
		// print layers
		for (int i = 0; i < layers.length; i++) {
			System.out.println("\nlayer"+i+":\nweights"+i+"="+layers[i].getParam("W")+"\nbias"+i+"="+layers[i].getParam("b"));
		}
